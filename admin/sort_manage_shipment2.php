...
{
if(confirm("Do you really want to delete this Shipments Report?"))
{
window.parent.location = "manage_shipment_report.php?id="+id;
}
}
</script>
<style>
.row {
	...
	<body>
      ...
      <table id="example" class="table table-striped table-bordered" width="98%" cellspacing="0" >
        ...
        <tbody>
          <?php $i=1;
										 ...
										 $select_class = "SELECT * FROM mst_shipment where status='4'";
      ...
      <table width="100%" >
      <tr><td colspan="8" align="center"><a href="export2.php"><img src="ssis-export-excel-file-task.png" style="width:5%; margin:auto; display:block;"></a></td></tr>
      </table>
